...
export default function LoginCallbackPage() {
  ...
  useEffect(() => {
    ...
    //
    // `completeLoginRedirect` shares one single-flight
    // `handleIncomingRedirect` with `ensureSession`, so the layout's header
    // (mounted here too) can't redeem the one-time code a second time and
    // reset the session.
